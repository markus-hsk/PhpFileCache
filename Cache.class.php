...
class Cache
{
	...
	private static function makeCacheDir($dir, $mode = 0777)
    {
        return is_dir($dir) or ( static::makeCacheDir(dirname($dir), $mode) and mkdir($dir, $mode) );
    }
}